...
Hooks.once('i18nInit', () => {
  DSAActiveEffectConfig.effectDurationRegexes = [
    {
      regEx: new RegExp(game.i18n.localize('DSAREGEX.combatRounds'), 'i'),
      seconds: 5,
    },
    {
      regEx: new RegExp(game.i18n.localize('DSAREGEX.minutes'), 'i'),
      seconds: 60,
    },
    {
      regEx: new RegExp(game.i18n.localize('DSAREGEX.hours'), 'i'),
      seconds: 3600,
    },
    {
      regEx: new RegExp(game.i18n.localize('DSAREGEX.days'), 'i'),
      seconds: 3600 * 24,
    },
    {
      regEx: new RegExp(game.i18n.localize('DSAREGEX.weeks'), 'i'),
      seconds: 3600 * 24 * 7,
    },
    {
      regEx: new RegExp(game.i18n.localize('DSAREGEX.months'), 'i'),
      seconds: 3600 * 24 * 30,
    },
    {
      regEx: new RegExp(game.i18n.localize('DSAREGEX.years'), 'i'),
      seconds: 3600 * 24 * 350,
    },
  ];
});
  ...
  dropDownMenu() {
    ...
    for (const k of models) {
      ...
      optns.push(
        {
          name: `${el} - ${FW}`,
          val: `system.skillModifiers.${k}.FW`,
          mode: 0,
          ph: demo,
        },
        {
          name: `${el} - ${FP}`,
          val: `system.skillModifiers.${k}.FP`,
          mode: 0,
          ph: demo,
        },
        {
          name: `${el} - ${stepValue}`,
          val: `system.skillModifiers.${k}.step`,
          mode: 0,
          ph: demo,
        },
        {
          name: `${el} - ${QS}`,
          val: `system.skillModifiers.${k}.QL`,
          mode: 0,
          ph: demo,
        },
        {
          name: `${el} - ${partChecks}`,
          val: `system.skillModifiers.${k}.TPM`,
          mode: 0,
          ph: demo,
        },
      );
