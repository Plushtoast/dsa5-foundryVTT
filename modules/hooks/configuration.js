...
export function setupConfiguration() {
  ...
  const settings = {
    ...
    // Information, privacy & token names
  ...
  const menus = {
    // Buttons at the top of the system settings tab
    changelog: {
      name: 'Changelog',
      label: 'Changelog',
