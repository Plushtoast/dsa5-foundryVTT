...
export default class AmmunitionData extends DSADataModel.mixin(DescriptionTemplate, EquipmentTemplate) {
  static defineSchema() {
    return this.mergeSchema(super.defineSchema(), {
      ...
      rangeMultiplier: new NumberField({ initial: 1, label: 'MODS.range', step: 0.1 }),
