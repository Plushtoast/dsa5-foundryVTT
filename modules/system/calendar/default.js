export const DSAKalender = {
  ...
  holidays: {
    values: [
      ...
      { name: 'Feste des Ausgleichs', month: 3, dayStart: 0, dayEnd: 2, gods: ['Peraine'] },
      ...
      { name: 'Wintersonnenwende', month: 6, dayStart: 0, gods: ['Phex', 'Nandus', 'Sumu', 'Rikai'] },
      { name: 'Tag der Jagd', month: 6, dayStart: 0, gods: ['Firun'] },
      ...
      { name: 'Versenkungsfest', month: 11, dayStart: 29, gods: ['Hesinde', 'Levthan'] },
