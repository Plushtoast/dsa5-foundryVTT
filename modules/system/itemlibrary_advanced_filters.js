...
Hooks.once('ready', () => {
  Promise.all([
    ...
    const filters = {
      ammunition: [
        {
          label: 'ammunitiongroup',
          attr: 'ammunitiongroup.value',
          type: 'select',
          options: DSA5.ammunitiongroups,
        },
      ],
      equipment: [
        {
          label: 'equipmentType',
          attr: 'equipmentType.value',
          type: 'select',
      ...
      book: [
        {
          label: 'BOOKITEM.format',
          attr: 'format',
          type: 'select',
          options: DSA5.bookFormats,
        },
        {
          label: 'BOOKITEM.quality',
          attr: 'quality',
          type: 'select',
          options: DSA5.bookQualities,
        },
        {
          label: 'BOOKITEM.exemplarType',
          attr: 'exemplarType',
          type: 'select',
          options: DSA5.exemplarTypes,
        },
      ...
      rangeweapon: [
        {
          label: 'TYPES.Item.combatskill',
          attr: 'combatskill.value',
          type: 'select',
          options: range,
        },
        {
      ...
      meleeweapon: [
        ...
        {
          label: 'guidevalue',
          attr: 'guidevalue.value',
          type: 'select',
          options: DSA5.combatskillsGuidevalues,
        },
        {
          label: 'reach',
          attr: 'reach.value',
          type: 'select',
          options: DSA5.meleeRanges,
        },
        { label: 'PLANT.region', attr: 'region', type: 'text' },
      ],
      poison: [
        {
          label: 'resistanceModifier',
          attr: 'resistance.value',
          type: 'select',
          options: DSA5.magicResistanceModifiers,
        },
        {
          label: 'COMBATSKILLCATEGORY.subcategory',
          attr: 'subcategory',
          type: 'select',
          options: DSA5.poisonSubTypes,
        },
      ...
      trait: [
        {
          label: 'traitType',
          attr: 'traitType.value',
          type: 'select',
          options: DSA5.traitCategories,
        },
      ],
      career: [
        {
          label: 'mageLevel',
          attr: 'mageLevel.value',
          type: 'select',
          options: DSA5.mageLevels,
        },
      ],
      specialability: [
        {
      ...
      npc: [
        {
          ...
          attr: 'details.species.value',
          type: 'text',
        },
        {
          label: 'TYPES.Item.career',
          attr: 'details.career.value',
          type: 'text',
        },
        {
          label: 'TYPES.Item.culture',
          attr: 'details.culture.value',
          type: 'text',
        },
      ],
      character: [
      ...
      creature: [
        ...
        {
          label: 'sizeCategory',
          attr: 'status.size.value',
          type: 'select',
          options: DSA5.sizeCategories,
        },
      ],
      armor: [
        {
          label: 'protection',
          attr: 'protection.value',
          type: 'select',
          options: {
            0: '0',
            1: '1',
      ...
      plant: [
        ...
        {
          label: 'PLANT.physical',
          attr: 'planttype.physical',
          type: 'checkbox',
        },
        { label: 'PLANT.psychic', attr: 'planttype.psychic', type: 'checkbox' },
        { label: 'PLANT.crop', attr: 'planttype.crop', type: 'checkbox' },
        {
          label: 'PLANT.defensive',
          attr: 'planttype.defensive',
          type: 'checkbox',
        },
        {
          label: 'PLANT.supernatural',
          attr: 'planttype.supernatural',
          type: 'checkbox',
        },
        {
          label: 'PLANT.highNorth',
          attr: 'availability.highNorth',
          type: 'range',
        },
        {
          label: 'PLANT.grasLands',
          attr: 'availability.grasLands',
          type: 'range',
        },
        ...
        {
          label: 'PLANT.mountains',
          attr: 'availability.mountains',
          type: 'range',
        },
        { label: 'PLANT.desert', attr: 'availability.desert', type: 'range' },
        {
          label: 'PLANT.maraskan',
          attr: 'availability.maraskan',
          type: 'range',
        },
      ],
      magicalsign: [],
