...
async function migrateDSA(currentVersion, migrationVersion) {
    await fetch("systems/dsa5/lazy/updatenotes.json").then(async r => r.json()).then(async json => {
        ...
        let msg = `<h1>CHANGELOG</h1><p>${json["default"].replace(/VERSION/g, version.version)}. </br><b>Important updates</b>: ${version.text}</p><p>For details or proposals visit our wiki page at <a href="https://github.com/Plushtoast/dsa5-foundryVTT" target="_blank">Github</a>. Have fun.</p>`
...
export default function migrateWorld() {
    Hooks.once("ready", async function() {
        ...
        const NEEDS_MIGRATION_VERSION = 5
